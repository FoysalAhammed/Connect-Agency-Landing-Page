            ...
            <div className="block">
              ...
              <ul className="mb-14 flex flex-col gap-1 w-[400px]">
                <li className="contactEmail px-2 text-xl font-semibold leading-normal text-white bg-violet-600 p-[4px] rounded-lg">
                  <a href="mailto:hanif.mia2233@gmail.com">
              ...
              <ul class=" flex flex-col gap-1 w-[400px]">
                <li class="contactEmail px-2 shadow-green-400 shadow-md text-xl font-semibold leading-normal text-green-500 bg-white p-2 rounded-lg"><a target="_blank" href=""> <i class="fa-brands fa-whatsapp text-[#00E676]"></i> Messege on Whatsapp</a></li>
              </ul>
              </ul>
            </div>
          </div>
